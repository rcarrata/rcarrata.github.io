...
This is because I need to know upfront which IP will be used as a sourceIP by my own workloads in order to not filter in the external host (or in the firewalls/IDS of my network).
