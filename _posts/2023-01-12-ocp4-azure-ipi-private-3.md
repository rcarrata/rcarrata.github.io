...
How can we generate Private clusters OpenShift in Azure, controlling our Outbound traffic with a scalable, managed Virtual NAT Gateway? What are the benefits of Azure Virtual NAT Gateways? And finally how can we configure our Azure Networking to use and benefit from the Virtual NAT?
