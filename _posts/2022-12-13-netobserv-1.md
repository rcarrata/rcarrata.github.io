...
NOTE: This blog post is tested on OpenShift 4.10.16 but can work with 4.10+ versions. It can also work on Kubernetes by adapting the manifests to not use OLM or by [installing OLM in Kubernetes](https://olm.operatorframework.io/docs/getting-started/).
