...
## 3. Deploying the NetObserv Flow Collector
...
## 4. Netobserv Grafana Dashboards
...
## 6. Deploying NetObserv using GitOps 

Because we don't like manual things, lets deploy all of this steps (including Prerequisites) using GitOps and ArgoCD!
