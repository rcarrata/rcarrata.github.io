...
How can you add Security to your DevOps pipelines? How can you shift left, securing your software lifecycle application development using DevSecOps tools and methods? How can we integrate RHACS in our DevOps pipelines?
...
To install the DevSecOps demo there are some prerequisites that we need to install before starting:
...
This automated deployment is based on Ansible, so we can deploy it in a couple of minutes with just a command!

```sh
./install.sh
```

## Accessing the credentials and resources for the DevSecOps demo
...
In upcoming blog posts, we will deep dive into each step of the DevSecOps CI/CD demo pipeline, making an analysis of the tools, methods and techniques used in the pipelines, and how we can leverage and increase our security in the DevOps pipelines!
