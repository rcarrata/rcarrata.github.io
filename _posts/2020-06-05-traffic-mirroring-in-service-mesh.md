...
How do you test with live production traffic in a safe, secure, and predictable way? How can we achieve
this within our Service Mesh? And what is traffic mirroring and how can it help with this use case?
...
In Kiali this mirrored traffic is visible: customer v1 shows that it is requested from the
client, but customer v2 is also sending traffic to the preference service, because of this traffic mirroring:
