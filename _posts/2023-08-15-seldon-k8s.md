...
To simplify the integration of machine learning components developed in diverse languages and toolkits, Seldon Core offers wrappers. These enable effortless creation of Docker containers from our code, suitable for execution within Seldon Core. The presently recommended tool for this purpose is [Red Hat's Source-to-Image](https://docs.openshift.com/container-platform/4.13/openshift_images/using_images/using-s21-images.html).

#### 6.2.2 Define and deploy the Seldon Core inference graph

Deploying our models using Seldon Core is simplified through Seldon pre-packaged inference servers and language wrappers, or by building our own [Seldon Inference Graphs](https://docs.seldon.io/projects/seldon-core/en/latest/graph/inference-graph.html).

In this case we will use the Seldon prebuilt [Sklearn Server](https://docs.seldon.io/projects/seldon-core/en/latest/servers/sklearn.html), but there are many more [prebuilt servers](https://docs.seldon.io/projects/seldon-core/en/latest/nav/config/servers.html) such as TensorFlow, Hugging Face, and other Seldon Inference Servers.
