...
You can find more information about MobileNetV2 in the official paper released by [Sandler et al](https://arxiv.org/abs/1801.04381v4).

* Let's deep dive a bit into the [ML App code](https://github.com/rcarrat-AI/k8s-mlops-gradio/blob/main/main.py)! 
...
* Essentially the [Containerfile](https://github.com/rcarrat-AI/k8s-mlops-gradio/blob/main/Dockerfile) is like any other Python app, so it's quite straightforward:
...
Let's test it with a [couple of examples](https://github.com/rcarrat-AI/k8s-mlops-gradio/tree/main/assets)!
